 ...
 */
class PostgreSQLImplementationTest extends \PHPUnit\Framework\TestCase
{
    use SharedFunctionalityTrait;

    private PostgreSQLImplementation $db;
    ...
    protected function setUp(): void
    {
        ...
        $this->db = new PostgreSQLImplementation($this->connection);
    }
    ...
    public function testUpsertNoUpdateRows(): void
    {
        ...
        $statement = $this->prepareForQueryWithVars($sql, $vars);
